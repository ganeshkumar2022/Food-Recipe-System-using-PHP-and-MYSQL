...
<header class="text-white bg-primary">
    <h4 class="py-4 ml-3">
    <i class="fa-solid fa-comment"></i>&nbsp;&nbsp;New Comments
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header bg-success text-white text-center">New Comments</div>
                        <div class="card-body">
...
<?php
include("../db.php");
$sql="select * from comments inner join recipe on comments.recipe_id=recipe.rid where comments.status='Waiting for Approval' and recipe.user_id=".$_SESSION["uid"];
