...
<header class="text-white bg-primary">
    <h4 class="py-4 ml-3">
    <i class="fa-solid fa-bowl-food"></i>&nbsp;&nbsp;Add Recipe
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header bg-success text-white text-center">List your Recipe details</div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" name="prepare_time" id="prepare_time" required>
                                </div>
                                <div class="col-md-3"></div>
                                
                                <div class="col-md-3"><p class="text-right font-weight-bold mt-1">Recipe cook time (in minutes)</p></div>
                                <div class="col-md-6">
                                    <input type="number" class="form-control" name="cook_time" id="cook_time" required>
                                </div>
                                <div class="col-md-3"></div>

                                <div class="col-md-3"><p class="text-right font-weight-bold mt-1">Yields (Eg.8 servings)</p></div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="yields" id="yields" required>
                                </div>
                                <div class="col-md-3"></div>
                                ...
                                <div class="col-md-3"><p class="text-right font-weight-bold mt-1">Choose picture</p></div>
                                <div class="col-md-6">
                                    <input type="file" name="myimage" class="mt-2 form-control" required>
                                </div>
                                <div class="col-md-3"></div>
                                ...
                                <div class="col-md-6">
                                    <center>
                                        <input type="submit" name="add_recipe" class="btn btn-primary mt-2" value="Update">
                                    </center>
                                </div>
                                <div class="col-md-3"></div>
                            </div>
