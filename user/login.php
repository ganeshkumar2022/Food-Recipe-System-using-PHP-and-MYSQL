            ...
            <div class="col-md-4 offset-md-4 mt-5">
                <div class="card mylogin-card">
                    <div class="card-body">
                        ...
                        <form action="" id="logform" method="post" autocomplete="off">
                            ...
                            <center>
                                 ...
                                 <br>
                                 <p class="mt-3">
                                    <b class="text-white">Don't have an Account ?</b>
                                    <a href="register.php" class="text-decoration-none text-white">Create an account</a><br>
